...
public class AiChatService {
    ...
    private static final String KNOWLEDGE_ONLY_NO_CONTEXT_MESSAGE = "Xin lỗi, mình chưa tìm thấy thông tin liên quan trong các tài liệu bạn đã tải lên. Bạn có thể thử diễn đạt câu hỏi theo cách khác, sử dụng tên đầy đủ của tài liệu bạn muốn tìm.";
